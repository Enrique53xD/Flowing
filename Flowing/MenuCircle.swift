        ...
        ZStack{
            ...
            Group{
                Image(systemName: "house")
                    .fontWeight(.heavy)
                    .foregroundStyle(.primary.opacity(deg == -135 ? 1 : 0.5))
                ...
                Image(systemName: "checkmark.circle")
                    .fontWeight(.heavy)
                    .foregroundStyle(.primary.opacity(deg == -90 || deg == 45 ? 1 : 0.5))
                ...
                Image(systemName: "gear")
                    .fontWeight(.heavy)
                    .foregroundStyle(.primary.opacity(deg == -45 || deg == 90 ? 1 : 0.5))
                ...
                Image(systemName: "house")
                    .fontWeight(.heavy)
                    .foregroundStyle(.primary.opacity(deg == 0 ? 1 : 0.5))
