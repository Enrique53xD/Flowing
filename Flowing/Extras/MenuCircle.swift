        ...
        ZStack {
            ...
            Group {
                ...
                Image(systemName: "chart.bar")
                    .fontWeight(.heavy)
                    .foregroundStyle(personalization.customColor ? personalization.mainColor.opacity(deg == 60 || deg == -60 || deg == -90 ? 1 : 0.5) : Color.primary.opacity(deg == 60 || deg == -60 || deg == -90 ? 1 : 0.5))
                    .font(deg == 60 || deg == -60 || deg == -90 ? .largeTitle : .title2)
                    .offset(y: 150)
                ...
                Image(systemName: "chart.bar")
                    .fontWeight(.heavy)
                    .foregroundStyle(personalization.customColor ? personalization.mainColor.opacity(deg == 90 || deg == 60 || deg == -60 ? 1 : 0.5) : Color.primary.opacity(deg == 90 || deg == 60 || deg == -60 ? 1 : 0.5))
                    .font(deg == 90 || deg == 60 || deg == -60 ? .largeTitle : .title2)
                    .offset(y: 150)
                    .rotationEffect(.degrees(-120))
                    .onTapGesture {
                        if deg != 90 && deg != 60 && deg != -60 {
                            withAnimation(.bouncy) {
                                deg -= 30
                            }
                        }
